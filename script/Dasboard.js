$('.page').on('click', function(){
    ...
    let sub =  $(this).find('.sub_pages').css('display');
    if(sub == 'none'){
    // $(this).find('i').remove();
    // $('.page').add('<i class="fas fa-chevron-down"></i>');
    $(this).find('#icon i').removeClass('fa-chevron-right');
    $(this).find('#icon i').addClass('fa-chevron-down');
    $(this).find('.sub_pages').css('display', 'block');
    }
    else{
        $(this).find('#icon i').removeClass('fa-chevron-down');
        $(this).find('#icon i').addClass('fa-chevron-right');
        $(this).find('.sub_pages').css('display', 'none');
    }
});
